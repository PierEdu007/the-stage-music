                ...
                <div className="space-y-2">
                  ...
                  >
                    <div className="flex items-center gap-4">
                      <span className="material-symbols-outlined text-white/40">{isVisualizerEnabled ? 'speed' : 'energy_savings_leaf'}</span>
                      <div className="flex flex-col">
                        <span className="text-sm font-medium">Modo Eco (Gama Baja)</span>
                        <span className="text-[10px] text-white/20 uppercase">Desactiva el visualizador para ahorrar batería y CPU</span>
                      </div>
                    </div>
                    <div className={`w-10 h-5 rounded-full relative transition-colors ${!isVisualizerEnabled ? 'bg-[#0d33f2]' : 'bg-white/10'}`}>
                      <div className={`absolute top-1 w-3 h-3 rounded-full bg-white transition-all ${!isVisualizerEnabled ? 'left-6' : 'left-1'}`}></div>
                    </div>
                  </div>
